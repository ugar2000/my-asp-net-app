...
{
    /// <inheritdoc />
    public partial class AddIdentityAndNews : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlgorithmName = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excerpt = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    ...
                    PublishedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlgorithmRuns_CreatedAtUtc",
                table: "AlgorithmRuns",
                column: "CreatedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_AlgorithmRuns_Family_AlgorithmName",
                table: "AlgorithmRuns",
                columns: new[] { "Family", "AlgorithmName" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubSessions_SessionId",
                table: "ClubSessions",
                column: "SessionId",
                unique: true);
